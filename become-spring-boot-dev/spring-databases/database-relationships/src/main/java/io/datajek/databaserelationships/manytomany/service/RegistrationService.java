...
import io.datajek.databaserelationships.manytomany.repository.RegistrationRepository;
...
public class RegistrationService {
    ...
    public io.datajek.databaserelationships.manytomany.Registration getRegistration(int id) {
